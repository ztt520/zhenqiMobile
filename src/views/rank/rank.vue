<template>
  <div id="rank">
    ...
    <div class="rankNav">
      ...
      <div class="city fr" @click="showregion()">{{Checkime}}<i class="el-icon-caret-bottom"></i></div>
    </div>
    <div class="airSort">
    ...
    <div class="table">
       <el-table :data="cityData" @sort-change='changeSort'>
        ...
        <el-table-column prop="complexindex" label="省份"></el-table-column>
        <el-table-column prop="pm10" label="AQI"></el-table-column>
        <el-table-column prop="so2" style="width:26%" label="首要污染物"></el-table-column>
     </el-table>
    </div>
  </div>
</template>
